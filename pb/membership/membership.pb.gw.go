...
func request_MembershipService_ListMembership_0(ctx context.Context, marshaler runtime.Marshaler, client MembershipServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq empty.Empty
	var metadata runtime.ServerMetadata

	msg, err := client.ListMembership(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterMembershipServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MembershipServiceClient) error {
	...
	mux.Handle("GET", pattern_MembershipService_ListMembership_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_MembershipService_ListMembership_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_MembershipService_ListMembership_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_MembershipService_ListMembership_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "memberships"}, ""))
)

var (
	forward_MembershipService_ListMembership_0 = runtime.ForwardResponseMessage
)
